...
Computes Spearman rho per dimension between:
  - VLM score (from saleability_labels, vlm_4head_v1)
...
Run:
    ...
    python -m survey.analysis.vlm_calibration --study-id calibration_v1 --vlm-source vlm_4head_v1
"""
...
def validate(
    ...
    vlm_source: str = typer.Option("vlm_4head_v1", help="VLM label source"),
) -> None:
