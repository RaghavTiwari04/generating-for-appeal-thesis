"""Headline mask geometry for inpainting-based text reservation.

Builds a binary mask reserving a rectangular region for headline text.
The diffusion pipeline (Flux Fill / SDXL Inpaint) keeps that region
